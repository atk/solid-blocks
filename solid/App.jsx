...
const App = () => {
    ...
    return (<div class="app" id="top">
      <Bar position="sticky" placement="top" portal={false}>
        <div style={{ flex: "1 1 50%", width: "auto" }}>
          <h1 style={{ "white-space": "nowrap", margin: "0" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 110 100" style="vertical-align: -0.1em;">
              <defs>
        ...
        <div style={{ flex: "1 1 50%", width: "auto" }}>
          <Button variant="icon" onClick={() => window.open("https://github.com/atk/solid-blocks", "_blank", "noopener,noreferrer") ||
            location.assign("https://github.com/atk/solid-blocks")}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="1em">
              <title>GitHub</title>
          ...
          <Checkbox switch setChecked={setDarkMode} checked={darkMode()} style={{ "white-space": "nowrap" }}>
