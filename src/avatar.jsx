...
export const AvatarGroup = (props) => (<div {...props} classList={mergeProps(props.classList ?? {}, { "sb-badge": true })} role="group" aria-haspopup={Array.isArray(props.children) && props.children.length > 3}/>);
